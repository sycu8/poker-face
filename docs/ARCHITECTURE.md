...
- **Client:** React SPA/PWA (Vite) with branded UI, passkeys, room table, chat, optional RealtimeKit voice.
...
- **D1:** Users, WebAuthn credentials, sessions, rooms, membership, join requests, hand summaries, idempotency keys.
